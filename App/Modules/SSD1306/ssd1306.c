...
#define SSD1306_I2C_RAW_ADDR   0x3C

// Send a byte to the command register
void ssd1306_WriteCommand(uint8_t byte) {
    I2C_WriteCommand(I2C1, SSD1306_I2C_RAW_ADDR, byte);
}

// Send data
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    I2C_SendData(I2C1, SSD1306_I2C_RAW_ADDR, buffer, (uint16_t)buff_size);
}
...
void ssd1306_UpdateScreen(void) {
    ...
    ssd1306_WriteCommand(0);                 // col start
    ssd1306_WriteCommand(SSD1306_WIDTH - 1);  // col end

    ssd1306_WriteCommand(0x22);              // set page address
    ssd1306_WriteCommand(0);                 // page start
    ssd1306_WriteCommand(SSD1306_HEIGHT/8 - 1); // page end
